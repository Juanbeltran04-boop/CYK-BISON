...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_A_TOKEN = 3,                    /* A_TOKEN  */
  YYSYMBOL_B_TOKEN = 4,                    /* B_TOKEN  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "A_TOKEN", "B_TOKEN",
  "$accept", "start", "S", "A", "B", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* start: S  */
#line 15 "mi_gramatic.y"
         { printf("Cadena válida.\n"); }
#line 1064 "mi_gramatic.tab.c"
    break;


#line 1068 "mi_gramatic.tab.c"
